...
GO
EXEC sp_addextendedproperty @name = N'MS_Description',
    @value = N'Código inmutable del estado de ensayo clínico.',
    @level0type = N'SCHEMA',
    @level0name = N'dbo',
    @level1type = N'TABLE',
    @level1name = N'ClinicRunStatus',
...
GO
EXEC sp_addextendedproperty @name = N'MS_Description',
    @value = N'Descripción amigable del estado de ensayo clínico.',
    @level0type = N'SCHEMA',
    @level0name = N'dbo',
    @level1type = N'TABLE',
    @level1name = N'ClinicRunStatus',
