CREATE TABLE SampleTransactionOrigin
(
...
EXEC sp_addextendedproperty @name = N'MS_Description',
    ...
    @level0name = N'dbo',
    @level1type = N'TABLE',
    @level1name = N'SampleTransactionOrigin',
    @level2type = N'COLUMN',
    @level2name = N'Id'
GO
EXEC sp_addextendedproperty @name = N'MS_Description',
...
GO
EXEC sp_addextendedproperty @name = N'MS_Description',
    @value = N'Código inmutable del tipo de origen de la transacción de muestra',
    @level0type = N'SCHEMA',
    @level0name = N'dbo',
    @level1type = N'TABLE',
    @level1name = N'SampleTransactionOrigin',
...
GO
EXEC sp_addextendedproperty @name = N'MS_Description',
    @value = N'Descripción amigable del tipo de origen de la transacción de muestra',
    @level0type = N'SCHEMA',
    @level0name = N'dbo',
    @level1type = N'TABLE',
    @level1name = N'SampleTransactionOrigin',
