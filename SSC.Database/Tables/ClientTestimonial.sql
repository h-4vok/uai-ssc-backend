...
(
	...
	PersonFullName NVARCHAR(500) NOT NULL,
	ClientId INT NULL,
...
EXEC sp_addextendedproperty @name = N'MS_Description',
    ...
    @level0name = N'dbo',
    @level1type = N'TABLE',
    @level1name = N'ClientTestimonial',
    @level2type = N'COLUMN',
    @level2name = N'Id'
GO
EXEC sp_addextendedproperty @name = N'MS_Description',
...
GO
EXEC sp_addextendedproperty @name = N'MS_Description',
    @value = N'Nombre completo de la persona que escribió la reseña.',
    @level0type = N'SCHEMA',
    @level0name = N'dbo',
    @level1type = N'TABLE',
    @level1name = N'ClientTestimonial',
    @level2type = N'COLUMN',
    @level2name = N'PersonFullName'
GO
EXEC sp_addextendedproperty @name = N'MS_Description',
    @value = N'Cliente de donde viene la reseña.',
    @level0type = N'SCHEMA',
    @level0name = N'dbo',
    @level1type = N'TABLE',
    @level1name = N'ClientTestimonial',
...
GO
EXEC sp_addextendedproperty @name = N'MS_Description',
    @value = N'El texto completo de la reseña.',
    @level0type = N'SCHEMA',
    @level0name = N'dbo',
    @level1type = N'TABLE',
    @level1name = N'ClientTestimonial',
